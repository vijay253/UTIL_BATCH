...
##Input run numbers##                                                                                                                                                                                             
inputFile="/home/${USER}/work/JLab/hallc_replay_lt/UTIL_BATCH/InputRunLists/ProductionLH2_ALL" # Path to your input file which is just a list of run numbers, see templates
